...
//        System.out.println("Run chat client.");
        ...
        try {
            ...
            // Как только подключились, создаем клиента
            ...
            // Запускаем отдельный поток на прослушивание
            client.listenForMessage();
            // Метод отправки сообщений будет работать на основном потоке, и при необходимости его блокировать
            client.sendMessage();
        } catch (IOException e) {
            e.printStackTrace();
        }
